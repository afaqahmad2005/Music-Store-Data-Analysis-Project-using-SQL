...
-- Q7: Let's invite the artists who have writing the most rock music in our dataset. Write a query that returns
-- the Artist’s name and total track count of the top 10 rock bands
...
-- Q8: Q3: Return all the track names that have a song length longer than the average song length. Return 
